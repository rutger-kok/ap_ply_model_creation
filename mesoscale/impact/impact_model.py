...
class ImpactModel(Interlaced3D, Interlaced2D):
    ...
    def create_clamp_part(self):
        ...
        self.clamp_part.engineeringFeatures.PointMassInertia(
            name='Clamp Mass-Inertia', region=rf_point_region, mass=1.0,
    ...
    def constrain_clamps(self):
        ...
        clamp_instances = [all_instances['Clamp Instance {}'.format(i)]
                           for i in range(1, 5)]
        rf_points = [inst.referencePoints.values()[0]
                     for inst in clamp_instances]
        ...
        self.model.ConcentratedForce(
            ...
            region=clamp_region, cf2=-1.0, amplitude='Smoothing Amplitude',
