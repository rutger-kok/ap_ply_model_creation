...
if __name__ == '__main__':
    ...
    grid1 = sigc.createGrids(tapeAngles=tapeAng, tapeWidths=(25,25,25), undulationWidth=rw)
    ...
    tapePaths = laminateCreation(
        grid1, tapeAngles=tapeAng, tapeWidths=(25,25,25), tapeSpacing=1, undulationWidth=rw)

    # print 'Length = ',[len(sublist) for sublist in tapePaths]
