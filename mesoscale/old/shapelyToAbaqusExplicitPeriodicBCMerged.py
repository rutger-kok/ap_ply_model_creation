...
from periodicBC_3D_MergedPart import periodicBC
...
allInstances = [inst for inst in laminateAssembly.instances.values()]
laminateAssembly.InstanceFromBooleanMerge(name='Temp',
                                          instances=allInstances,
                                          mergeNodes=ALL,
                                          nodeMergingTolerance=1e-6,
                                          domain=MESH,
                                          originalInstances=DELETE)

allInstances = [inst for inst in laminateAssembly.instances.values()]
laminateAssembly.InstanceFromBooleanMerge(name='MergedPart',
                                          instances=allInstances,
                                          mergeNodes=ALL,
                                          nodeMergingTolerance=1e-6,
                                          domain=MESH,
