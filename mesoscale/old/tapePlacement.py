        ...
        for tape in tapes:
            ...
            if a == 90:
                ...
                for os in offsetList:
                    tapeCoords = ([(-300.0 + os + shift, (w / 2.0) - r),
                                   (300.0 + os + shift, (w / 2.0) - r),
                                   (300.0 + os + shift, (-w / 2.0) + r),
                                   (-300.0 + os + shift, (-w / 2.0) + r)])
                    afpPass = sigc.afpPass(grid, coords=tapeCoords,
                                               angle=90, undulationWidth=r)
                    createdTape = afpPass.connectivity
                ...
                shift = numShift * offset
                for os in offsetList:
                    tapeCoords = ([(-300.0, ((w / 2.0) - r) + os + shift),
                                   (300.0, ((w / 2.0) - r) + os + shift),
                                   (300.0, ((-w / 2.0) + r) + os + shift),
                                   (-300.0, ((-w / 2.0) + r) + os + shift)])
                    createdTape = sigc.afpPass(
