...
def createUndulation(h_u, h_f, ratio):
    ...
    # apply displacement BC to right surface
    undulationModel.DisplacementBC(
    ...
    # determine contacts
    undulationModel.contactDetection(defaultType=CONTACT_STANDARD,
    ...
    undulationModel.interactions['CP-1-Undulation Instance-Warp Instance'].setValues(
        sliding=SMALL, enforcement=SURFACE_TO_SURFACE, 
        surfaceSmoothing=AUTOMATIC, interactionProperty='Cohesive', 
        adjustMethod=NONE)
    undulationModel.interactions['CP-2-Undulation Instance-Warp Instance'].setValues(
        sliding=SMALL, enforcement=SURFACE_TO_SURFACE, 
        surfaceSmoothing=AUTOMATIC, interactionProperty='Cohesive', 
        adjustMethod=NONE)
